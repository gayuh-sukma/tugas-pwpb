...
<div class="modal-body">
  <form action="<?= BASEURL ?>/mahasiswa/tambah" method="post">
     <input type="hidden" name="id" id="id">
      ...
      <div class="form-group">
          <label>image</label>
          <img src="gambar/<?php echo $data['image']; ?>" style="width: 120px;float: left;margin_bottom: 5px;">
      <input type="file" class="form-control" id="image" name="image">
        <i style center="float: left;font-size: 11px;color: blue">Abaikan jika image tidak berubah thumbnailnya</i>
      </div>
